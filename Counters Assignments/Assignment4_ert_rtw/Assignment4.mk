###########################################################################
## Makefile generated for Simulink model 'Assignment4'. 
## 
## Makefile     : Assignment4.mk
## Generated on : Mon Aug 30 10:37:33 2021
## MATLAB Coder version: 4.2 (R2019a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Assignment4.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/Counters Assignments
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
COMPILER_COMMAND_FILE     = Assignment4_comp.rsp
CMD_FILE                  = Assignment4.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Assignment4.exe
...
DEFINES_STANDARD = -DMODEL=Assignment4 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/Assignment4_ert_rtw/Assignment4.c

MAIN_SRC = $(START_DIR)/Assignment4_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/Assignment4_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Assignment4_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
