###########################################################################
## Makefile generated for Simulink model 'untitled1'. 
## 
## Makefile     : untitled1.mk
## Generated on : Mon Aug 30 11:39:11 2021
## MATLAB Coder version: 4.2 (R2019a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/untitled1.exe
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/untitled1.exe
...
SRCS = $(START_DIR)/untitled1_ert_rtw/untitled1.c
...
%.obj : $(START_DIR)/untitled1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/untitled1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
